...
const DICT = {
  en: {
    ...
    SYNAPSE_EMPTY: "No anchors yet — run engram-quest-synapse to build connections.",
    SYNAPSE_LOCKED: "Synapse is a Pro feature.",
    SYNAPSE_REASON_PREFIX: "↳ ",
    SYNAPSE_NO_BACK: "Anchor back not loaded in this session.",
    SYNAPSE_ONBOARDING_TITLE: "Welcome to Pro! Run engram-quest-synapse to enable ⚡ anchors.",
    SYNAPSE_REFRESH_BANNER: "Synapse looks out of date. Re-run engram-quest-synapse to refresh anchors.",
  ...
  "zh-tw": {
    ...
    SYNAPSE_EMPTY: "尚未建立連結 — 執行 engram-quest-synapse 自動建立。",
    SYNAPSE_LOCKED: "Synapse 是 Pro 功能。",
    SYNAPSE_REASON_PREFIX: "↳ ",
    SYNAPSE_NO_BACK: "此 session 未載入此錨點的答案。",
    SYNAPSE_ONBOARDING_TITLE: "歡迎升級 Pro！執行 engram-quest-synapse 以啟用 ⚡ 連結。",
    SYNAPSE_REFRESH_BANNER: "Synapse 資料可能過期，請重新執行 engram-quest-synapse 更新連結。",
